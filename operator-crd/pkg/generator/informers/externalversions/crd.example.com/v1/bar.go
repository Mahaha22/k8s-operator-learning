...
import (
	...
	internalinterfaces "operator-crd/pkg/generator/informers/externalversions/internalinterfaces"
	v1 "operator-crd/pkg/generator/listers/crd.example.com/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1().Bars(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1().Bars(namespace).Watch(context.TODO(), options)
			},
		},
		&crdexamplecomv1.Bar{},
		resyncPeriod,
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdexamplecomv1.Bar{}, f.defaultInformer)
}
